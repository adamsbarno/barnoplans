...
app.use(['/data/orders.json', '/data/catalog-overrides.json', '/data/catalog-additions.json', '/data/contact-submissions.json'], (request, response) => response.status(404).json({ error: 'Not found' }));
